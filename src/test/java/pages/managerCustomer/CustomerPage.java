...
public class CustomerPage {
    ...
    public void verifySearchSuccess(String key, List<WebElement> listCustomer) {
        ...
        for (int i = 1; i < listCustomer.size(); i++) {
            try {
                List<WebElement> columns = listCustomer.get(i).findElements(By.tagName(" "));
        ...
        List<WebElement> listCus = customerTable.findElements(By.tagName("tr"));
        assertEquals(listCus.containsAll(newList), true);
    }
